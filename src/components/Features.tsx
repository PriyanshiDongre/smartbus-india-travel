  ...
  return (
    <section className="py-16 bg-white">
      <div className="container">
        <h2 className="text-3xl font-bold text-center mb-4 text-smartbus-text-dark">Smart Features for Smarter Travel</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="p-6 border rounded-xl hover:border-smartbus-blue hover:shadow-md transition-all"
            >
              <div className="mb-4 p-3 inline-block rounded-full bg-smartbus-gray">
                {feature.icon}
              </div>
              <h3 className="text-xl font-bold mb-2 text-smartbus-text-dark">{feature.title}</h3>
